...
{
    public class NoAutoDetectChangesConfiguration : IRunnableInsertConfiguration, IRunnableUpdateConfiguration
    {
        ...
        public NoAutoDetectChangesConfiguration(IConnectionString connectionString)
        {
